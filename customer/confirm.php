   ...
   <div id="top"><!-- Top Begin -->
       ...
       <div class="container"><!-- container Begin -->
           ...
           <div class="col-md-6 offer"><!-- col-md-6 offer Begin -->
               ...
               <a href="checkout.php"> <?php items(); ?> sản phẩm trong giỏ hàng |Tổng giá: <?php total_price(); ?> </a>
           ...
           <div class="col-md-6"><!-- col-md-6 Begin -->
               ...
               <ul class="menu"><!-- cmenu Begin -->
                   ...
                   <li>
                       <a href="../cart.php">Đi tới giỏ hàng</a>
                   </li>
                   <li>
                       <a href="../checkout.php">
    ...
    ?>
           ...
           <div class="col-md-9"><!-- col-md-9 Begin -->
               ...
               <div class="box"><!-- box Begin -->
                   ...
                   <h1 align="center"> Xác nhận phương thức thanh toán</h1>
                   ...
                   <form action="confirm.php?update_id=<?php echo $order_id;  ?>" method="post" enctype="multipart/form-data"><!-- form Begin -->
                       ...
                       <div class="form-group"><!-- form-group Begin -->
                         ...
                         <label> airpay / Viettelpay / Western Union Code: </label>
                   ...
                   <?php 
                    ...
                    if(isset($_POST['confirm_payment'])){
                        ...
                        if($run_pending_order){
                            ...
                            echo "<script>alert('Cảm ơn bạn đã đặt hàng. Đơn hàng sẽ được xác nhận trong vòng 24 giờ')</script>";
